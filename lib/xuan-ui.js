import { computed as I, openBlock as k, createElementBlock as A, mergeProps as P, unref as w, useCssVars as V, ref as _, onMounted as j, createElementVNode as C, normalizeStyle as G, createBlock as D } from "vue";
const b = (s, t) => {
...
const H = {
  ...
  setup(s) {
    ...
    return (e, l) => (k(), A("i", P(e.$attr, { class: w(i) }), null, 16));
  }
}), E = /* @__PURE__ */ b(W, [["__scopeId", "data-v-dcc68724"]]);
const Y = { class: "vtc-container" }, J = ["src", "width", "height"], K = ["width", "height"], Q = {
  ...
  setup(s) {
    ...
    const B = (a) => {
      ...
      const n = a.data, o = a.width, L = a.height, v = [];
      for (let c = 0; c < L; c++) {
        const p = [];
        for (let u = 0; u < o; u++) {
...
}), R = /* @__PURE__ */ b(X, [["__scopeId", "data-v-200048ac"]]), Z = [O, R, E], te = {
  install: (s) => {
    Z.forEach((t) => {
